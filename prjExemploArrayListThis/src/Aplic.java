...
public class Aplic {
	...
	//instanciação de  um objeto da 
       ...
       objDep1.addFuncionario(funcHor); // Departamento aponta para Funcionario e o Funcionario aponta pro Departamento
       ...
       objPrj.addFuncionario(funcHor); // Projeto aponta para Funcionario e o Funcionario aponta pro Projeto
