...
public class Projeto {
    ...
    public Projeto(int codigo, String descricao) {
        ...
        funcionarios = new ArrayList();  //Forma simplificada
    }
    ...
    public void addFuncionario(Funcionario f){ 
        funcionarios.add(f); // Projeto -> Funcionario (horista, mensalista e comissionado)
        f.setProjeto(this); // Funcionario (horista, mensalista e comissionado) -> Projeto
    }
