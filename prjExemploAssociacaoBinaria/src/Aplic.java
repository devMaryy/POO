...
public class Aplic {
    public static void main(String[] args) {
        ...
        //Estabelece a associação entre um objeto da classse FuncionárioHorista com um objeto da classe Departamento:
        ...
        //Estabelece a associação entre um objeto da classse FuncionárioMensalista com um objeto da classe Departamento:
        funcMen.setDepartamento(dep1);
        
        System.out.println("O funcionário mensalista " + funcMen.getNome() + 
                            " trabalha no departamento de " + 
                            funcMen.getDepartamento().getSigla() + " (" 
                            + funcMen.getDepartamento().getNome() +")");
    
        //Estabelece a associação entre um objeto da classse FuncionárioComissionado com um objeto da classe Departamento:
        ...
        //Estabelece a associação entre um objeto da classe Departamento com um objeto das classes FuncionarioHorista e FuncionarioMensalista:
        dep1.addFuncionario(funcHor);
        dep1.addFuncionario(funcMen);
        
    
        //Estabelece a associação entre um objeto da classe Departamento com um objeto da classe FuncionarioComissionado:
